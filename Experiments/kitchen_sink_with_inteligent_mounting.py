...
class KitchenSink(App):
    ...
    def show_example_dialog(self):
      if (os.path.isdir('A:') or os.path.isdir('B:') or os.path.isdir('D:') or os.path.isdir('G:') or os.path.isdir('H:') or os.path.isdir('I:') or os.path.isdir('J:') or os.path.isdir('K:') or os.path.isdir('M:') or os.path.isdir('T:') or os.path.isdir('U:') or os.path.isdir('V:') or os.path.isdir('W:') or os.path.isdir('X:') or os.path.isdir('Y:') or os.path.isdir('Z:')) :   
           content = MDLabel(font_style='Body1',
                          theme_text_color='Secondary',
                          text="A drive has been mounted! \n"
                               "That's pretty awesome, right?",
                          valign='top')
      else :
          content = MDLabel(font_style='Body1',
                          theme_text_color='Secondary',
                          text="Nothing has been mounted. ",
                          valign='top')
